...
public class Activity_truyen extends AppCompatActivity {
    ...
    public void loadPoducts_categories()
    {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recyclerview_Truyen);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (products.getCategories_id().contains("CT04"))
                    {
    ...
    public void actionBack() {
        imageView_back = findViewById(R.id.idback_truyen);
