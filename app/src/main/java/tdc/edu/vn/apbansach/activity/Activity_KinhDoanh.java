...
public class Activity_KinhDoanh extends AppCompatActivity {
    ...
    public void loadPoducts_categories()
    {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recyclerview_KD);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (products.getCategories_id().contains("CT03"))
                    {
    ...
    public void actionBack() {
        imageView_back = findViewById(R.id.idback_KD);
